const lang = {
    ...
    userCenter:{
        ...
        Frontal:"Frontal photo of document",
        Reverse:"Reverse photo of document",
        signature:"Hold the frontal photo of the document and handwritten signature",
        Submitverify:"Submit to verify",
        photo:"Upload photo",
    ...
    ApplicationCoin:{
        ...
        SupportFormat:'It is recommended to upload picture with 96*96 pixels, only support jpg, png format, the size need to be smaller than 300KB.',
        ...
        AppliedProjects:'The submitted materials will be reviewed in 15-20 working days. For the specific results, please refer to “Applied projects” in “Deposit” module.',
        Confirm:'Confirm',
        ...
        ProjectNameNotLess:'Project name can not be less than 10 characters and exceed 1000 characters.',
        ProjectNameNotLess3Ch:'The introduction can not be less than 10 characters and exceed 500 characters.',
        CoinFullNotLess:'Coin full name cannot be less than 1 characters and exceed 30 characters.',
        CoinShortNnotLess:'Coin short name cannot be less than 1 characters and exceed 8 characters.',
        ReSelect:'Uploaded file is larger than 5M, please re-select.',
        SuccessfulUpload:'Successful upload',
        UploadedPhotoLarger:'Uploaded photo is larger than 500k, please re-select.',
    ...
    WalletManagement:{
        ...
        Pleaseenter:"Please enter coin short name",
        Open:'Open',
        ...
        TokenNameLength:'Token name length is 1-20 characters',
        Resend:'Resend',
